...
export class CmpApiModel {
  ...
  private static isPurposeRestrictionVector(
    potentialVector: unknown
  ): potentialVector is PurposeRestrictionVector {
    let retr = false;
  ...
  private static isTCModel(
    potentialTCModel: unknown
  ): potentialTCModel is TCModel {
    let retr = false;
    ...
    retr =
      retr && this.isPurposeRestrictionVector(subject.publisherRestrictions);
